...
public class menuBox {
	...
	public menuBox(int ox, int oy, int width, int height, String text) {
		...
		String split[] = text.split(" ", 3); // splittar stringen i flera (3)
												// strings "runt" mellanrum

		if (split[0].equals("HEADER")) { // Gör ändringar om stringen har HEADER
											// först, dvs. är rubrik.
			this.header = true;
			this.text = split[2];
			this.fontSizeMultiple = Integer.parseInt(split[1]); //// multiplicerar
																//// fontstorlek
																//// med andra
																//// splittade
																//// biten,
																...
																//// rubrik, som
																//// int
			BufferedImage unused = new BufferedImage(SimpleGameEngine.windowWidth, SimpleGameEngine.windowHeight,

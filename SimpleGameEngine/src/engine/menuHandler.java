...
public class menuHandler {
	...
	public menuHandler() {
		...
		menus.add(pauseMenu);
		warningMenu = new menu("Warning", "HEADER 2 Unsaved progress will be lost", "Continue to main menu", "Cancel"); // En
																														// rubrik
																														// addas
																														// genom
																														// att
																														// sätta
																														// till
		menus.add(warningMenu); // HEADER i början av stringen och sedan en
								// siffra. Siffran säger hur många gånger större
								// font rubriken har.
		menus.add(SimpleGameEngine.savingSystem.saveMenu); // OBS! MÅste vara
															// mellanrum som
															// ovan. Se menuBox.
